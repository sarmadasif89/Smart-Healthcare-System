...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Corresponding Visit</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                ...
                                <form class="from-group" action="#" method="POST" enctype="multipart/form-data" >
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Reason</label>
                                            <textarea disabled="true" class="form-control" name="reason" tabindex="1"> <?php echo $get_visitreason['reason']; ?> </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            <label>Symptoms</label>
                                            <textarea disabled="true" class="form-control" name="symptoms" tabindex="2"><?php echo $get_visitreason['symptoms']; ?></textarea>
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label>Condition</label>
                                            <select class="form-control" disabled="true" name="condition" tabindex="3">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <select class="form-control" disabled="true" name="visittype" tabindex="4">
                                                <option>Select</option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control" disabled="true" name="precautions_taken_prior_to_visit" tabindex="5"><?php echo $get_visitreason['precautions_taken_prior_to_visit']; ?> </textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-lg-4">
